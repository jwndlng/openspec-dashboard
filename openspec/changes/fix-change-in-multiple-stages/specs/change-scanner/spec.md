...
- **THEN** `audit-trail` is reported once, archived on `2026-09-20`, and the main checkout is listed among its other checkouts as `Synced`; no active `audit-trail` is reported
