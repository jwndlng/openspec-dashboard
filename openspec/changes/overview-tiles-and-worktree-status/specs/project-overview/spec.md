...
- **THEN** the header shows `Projects / alpha-infra`, the path, three chips — `main` labelled as the main checkout, `feat/report` and `fix/parser` — and `updated 1d ago`
